...
@router.get("/inventory", response_model=List[inventory_schema.Inventory], dependencies=[Depends(require_permission(Action.VIEW_INVENTORY, "Inventory"))])
...
@router.get("/inventory/{sku_id}", response_model=List[inventory_schema.Inventory], dependencies=[Depends(require_permission(Action.VIEW_INVENTORY, "Inventory"))])
