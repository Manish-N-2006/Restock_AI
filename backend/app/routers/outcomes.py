...
@router.post("/from-transfer/{transfer_id}", response_model=OutcomeResponse)
...
@router.post("/{outcome_id}/record-sales", response_model=OutcomeResponse)
...
@router.post("/{outcome_id}/record-financials", response_model=OutcomeResponse)
...
@router.post("/{outcome_id}/finalize", response_model=OutcomeResponse)
